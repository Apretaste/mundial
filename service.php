...
class Mundial extends Service{
  ...
  **/
  public function _main(Request $request){
    return $this->_calendario($request);
  }
  ...
  public function _calendario(Request $request){
    ...
    //$response->setEmailLayout('mundial.tpl'); Aun no esta hecho, los archivos que existen son una copia de Pizarra para guiarme
  ...
  public function _apuestas(Request $request){
